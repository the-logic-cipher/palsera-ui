angular.module('app.shipment', ['ui.router'])
    ...
    .controller('unShipmentCtrl', ['$scope', '$state', 'API', 'Auth', '$modal', 'toaster', 'UtilService',
        function ($scope, $state, API, Auth, $modal, toaster, Util) {
            ...
            function Restruct_search(order) {
              this.name = order.school[0].name.replace(/\\/g, '');
    ...
    .controller('ShipmentCtrl', ['$scope', '$state', 'API', 'Auth', '$modal', 'UtilService',
    ...
    .controller('OrderViewCtrl', ['$scope', '$state', 'API', 'Auth', '$modal', '$stateParams', 'toaster', '$http',
        function ($scope, $state, API, Auth, $modal, $stateParams, toaster, $http) {
            ...
            $scope.print = function (type) {
                ...
                var zpl_encoded;
                if (type === 'shipment') {
                  zpl_encoded = $scope.model.shipment.ShipmentResults[0].PackageResults[0].LabelImage[0].GraphicImage[0];
                } else if (type === 'return') {
                  zpl_encoded = $scope.model.returnedShipment.ShipmentResults[0].PackageResults[0].LabelImage[0].GraphicImage[0];
                } else if (type === 'extra') {
                  zpl_encoded = $scope.model.extraShipment.ShipmentResults[0].PackageResults[0].LabelImage[0].GraphicImage[0];
                }
